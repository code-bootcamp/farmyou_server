...
export class PaymentService {
    ...
    async findCompletedPayments(userId) {
        return await this.paymentRepository
            ...
            .leftJoinAndSelect('payment.seller', 'seller1')
            .leftJoinAndSelect('payment.admin', 'admin1')
            .leftJoinAndSelect('payment.productDirect', 'productDirect')
            .leftJoinAndSelect('productDirect.admin', 'admin2')
            ...
            .leftJoinAndSelect('productUgly.seller', 'seller2')
